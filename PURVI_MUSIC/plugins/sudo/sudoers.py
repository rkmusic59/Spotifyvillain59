...
from PURVI_MUSIC.utils.database import add_sudo, remove_sudo
from PURVI_MUSIC.utils.decorators.language import language
from PURVI_MUSIC.utils.extraction import extract_user
from PURVI_MUSIC.utils.inline import close_markup
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_video(video="", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("𝐒𝐮𝐝𝐨 𝐋𝐢𝐬𝐭 𝐊 𝐁𝐚𝐝𝐥𝐞 ꪜ 𝛊 ɭ ɭ ᧘ 𝛊 𝛈 𝐊𝐚 𝐋𝐮𝐧𝐝 𝐋𝐞 𝐋𝐞🖕😎😂", show_alert=True)
    else:
